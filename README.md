...
3. Clone the class content into the folder using:
   ...
   ```bash
   git clone https://github.com/NM-TAFE/dip-ai-rest-api-mcp-classes.git
   ```
...
```bash
git remote add upstream https://github.com/NM-TAFE/dip-ai-rest-api-mcp-classes.git
```
...
upstream  https://github.com/NM-TAFE/dip-ai-rest-api-mcp-classes.git (fetch)
upstream  https://github.com/NM-TAFE/dip-ai-rest-api-mcp-classes.git (push)
```
